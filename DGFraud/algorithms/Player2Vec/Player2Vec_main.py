...
def train(args, adj_list, features, train_data, train_label, test_data, test_label, paras):
    ...
    np.savetxt("./batch_losses.txt", np.asarray(batch_losses))
    print("Saved!")
    np.savetxt("./batch_accs.txt", np.asarray(batch_accs))
    np.savetxt("./epochs.txt", np.asarray(epochs))
    np.savetxt("./train_losses.txt", np.asarray(train_losses))
    np.savetxt("./train_accs.txt", np.asarray(train_accs))
    print("test accdsvdvsdv:", test_acc)
